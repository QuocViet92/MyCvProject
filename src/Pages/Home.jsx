    ...
    return (
        <div className='Home'>
            <div className='detail'>
                <NavLink to={'about'} className='home-avarta'>
                    <img
                        className='avarta-large animition-left'
                ...
                <div className='boderInfo'>
                    <div className='info'>
                        <h1 className='title-info animition-top'>
                            Hi 👋, My name is
                            <br />
                            <NavLink to={'about'}>
                                <span className='home-name text-highlight'>
                                    Quoc Viet Luong
                                </span>
                            </NavLink>{' '}
