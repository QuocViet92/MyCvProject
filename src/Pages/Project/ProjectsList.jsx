    ...
    return (
        <div className='container'>
            ...
            <div className='filter-project'>
                <button
                    className={`animition-left ${
                        typeFilter === 'html,css,js' ? 'selected' : ''
                    } `}
                    onClick={() => handleFilterChange('type', 'html,css,js')}>
                    Html, Css, Js
                </button>
                <button
                    className={`animition-right ${
                        typeFilter === 'reactjs' ? 'selected' : ''
                    } `}
                    onClick={() => handleFilterChange('type', 'reactjs')}>
                    ReactJs
                </button>
            ...
            <div className='projects-list animition-left'>{element}</div>
